...
!     ,OMEX(NX+4,NY+4,NZ+4),OMEY(NX+4,NY+4,NZ+4)&   !GAL?��?��?��?��OMEX,Y,Z?��?��OMEXG,YG,ZG?��ɕϝX
!     ,OMEZ(NX+4,NY+4,NZ+4),HKW(NX+4,NY+4,NZ+4)&
!     ,HKU(NX+4,NY+4,NZ+4),HKV(NX+4,NY+4,NZ+4)&
!     ,DD1(NX+4,NY+4,NZ+4),DD2(NX+4,NY+4,NZ+4)&   !GAL?��?��?��?��DD1,2,3?��?��DD1G,2G,3G?��ɕϝX
!     ,DD3(NX+4,NY+4,NZ+4)&
...
!C
      REAL(8) :: UA(NX+5),C3
      REAL(8) :: UKG(NX+4,NY+4,NZ+4),UKE(NX+4,NY+4,NZ+4)    !SAL?��ł�?��?��?��l?��̎�
      REAL(8) :: VKG(NX+4,NY+4,NZ+4),VKE(NX+4,NY+4,NZ+4)    !SAL?��ł�?��?��?��l?��̎�
      REAL(8) :: MYTGENE(NX+4,NY+4,NZ+4),MYTEENE(NX+4,NY+4,NZ+4)    !SAL?��ł�?��?��?��l?��̎�
      REAL(8) :: AK0(NX+4,NY+4,NZ+4)
      REAL(8) :: UK(NX+4,NY+4,NZ+4),VK(NX+4,NY+4,NZ+4),CKC    !SAL?��ł�?��?��?��l?��̎�
!
!C----------Original Dimension----------C
...
!c      &                   IGL(1,5)+1,IETA(1,5)
        ...
        !I=1
        !DO 3224 K=1,KMAX+4
        !DO 3224 J=IGL(I,K)+1,IETA(I,K) !�ϓ�������Ν����z�ɕt��
